...
It accumulates [rococo](https://rococo.network) account transfers and serves them via GraphQL API.
...
```json5
{
  ...
  specVersions: "https://rococo.archive.subsquid.io/graphql",
  events: [
